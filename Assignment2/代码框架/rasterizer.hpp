...
namespace rst
{
    ...
    private:
        ...
        int ssaa = 2;//for height and width set 2 * 2 SSAA
        float pixel_sample_size = 1.0 / ssaa;
        float start_point_per_pixel = pixel_sample_size / 2;

        std::vector<float> msaa_check_edge;//try
